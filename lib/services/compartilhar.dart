...
class _CompartilharState extends State<Compartilhar> {
  ...
  "deviceInfo": {
    "hardware": {
      ...
      "model": "Moto G",
      "product": "aosp_falcon",
      "fingerprint": "motorola/falcon_retbr_ds/falcon_umtsds:5.1/LPB23.13-56/58:user/release-keys",
      "serial": "0428078038",
    ...
    "comp": {
      ...
      "wv_ua": "Mozilla/5.0 (Linux; Android 7.1.2; Build/NZH54B; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/59.0.3071.125 Mobile Safari/537.36"
    }
  }
};
